...
function calc(num1,opera,num2){
    if(opera === "+"){
        ...
        return "Incorrect operator assigned"
    }
}

var answer = calc(2,"*",10);
var answer1 = calc(20,"-",5);
var answer2 = calc(200,"+",12);
var answer3 = calc(5,"/",10);
document.write(answer + "<br>" + answer1 + "<br>" + answer2 + "<br>" + answer3);
